...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', type=str, default='rct_net_test')
    ...
    parser.add_argument('--manual_seed', default=9719, type=int, metavar='S',
    ...
    parser.add_argument('--model_type', type=str, default='clsiou',
