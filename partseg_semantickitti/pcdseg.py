...
from rct_net.models.rct_net import rct_net
...
KITTI_ROOT = 'data/semantickitti'

def parse_args(notebook = False):
    parser = argparse.ArgumentParser('PointNet')
    parser.add_argument('--mode', default='train', choices=('train', 'eval'))
    parser.add_argument('--model_name', type=str, default='rct_net', choices=('pointnet', 'pointnet2','rct_net'))
...
def train(args):
    ...
    elif args.model_name == 'rct_net':
        model = rct_net(num_classes=19)
    ...
    for epoch in range(init_epoch,args.epoch):
        ...
        acc, miou = test_kitti_semseg(model.eval(points=test_npts), testdataloader,
