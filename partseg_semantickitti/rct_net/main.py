"""
Usage:
python main_test.py --model PointMLP --msg demo
"""
import argparse
import os
import logging
...
import numpy as np
from deepla.deepla_semseg import DeepLA_semseg
...
def parse_args():
    ...
    parser.add_argument('--msg', type=str, default='mn40_256',help='message after checkpoint')
    parser.add_argument('--batch_size', type=int, default=32, help='batch size in training')
    parser.add_argument('--model', default='pointMLP', help='model name [default: pointnet_cls,pointMLP]')
    parser.add_argument('--epoch', default=300, type=int, help='number of epoch in training')
    parser.add_argument('--num_points', type=int, default=256, help='Point Number')
    ...
    parser.add_argument('--seed', default=9719, type=int, help='random seed')
...
def main():
    ...
    # train_loader = DataLoader(ModelNet10(partition='train', num_points=args.num_points), num_workers=args.workers,
    #                           batch_size=args.batch_size, shuffle=True, drop_last=True)
    # test_loader = DataLoader(ModelNet10(partition='test', num_points=args.num_points), num_workers=args.workers,
    #                          batch_size=args.batch_size // 2, shuffle=False, drop_last=False)
