...
Usage:
python main_test.py --model PointNet --msg demo
or
CUDA_VISIBLE_DEVICES=0 nohup python main_test.py --model PointNet --msg demo > nohup/PointNet_demo.out &
"""
import argparse
import os
import logging
...
def parse_args():
    ...
    parser.add_argument('--msg', type=str, default='cot_scan_PBT50RS_nolocal',help='message after checkpoint')
    parser.add_argument('--batch_size', type=int, default=16, help='batch size in training')
    parser.add_argument('--model', default='rct_net', help='model name [default: pointnet_cls]')
    ...
    parser.add_argument('--seed', type=int, default=9719, help='random seed')
